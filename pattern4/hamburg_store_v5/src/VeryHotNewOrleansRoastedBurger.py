#######################################################
#
# VeryHotNewOrleansRoastedBurger.py
# Python implementation of the Class VeryHotNewOrleansRoastedBurger
...
class VeryHotNewOrleansRoastedBurger(Hamburg):
    def __init__(self, ingredientFactory: IngredientsFactory) -> None:
        super().__init__("New Orleans Roasted Hambruger", ingredientFactory)
