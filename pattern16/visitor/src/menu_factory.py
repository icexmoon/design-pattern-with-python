...
class MenuFactory:
    ...
    def getBarbecueHouseMenu(cls) -> Menu:
        ...
        menu.addMenuItem(MenuItem("烤韭菜", 3, True))
        menu.addMenuItem(MenuItem("烤茄子", 3, True))
        menu.addMenuItem(MenuItem("烤土豆", 3, True))
        return menu
    ...
    def getBurgerJointMenu(cls) -> Menu:
        ...
        menu.addMenuItem(MenuItem("蔬菜沙拉", 15, True))
        menu.addMenuItem(MenuItem("可乐", 15, True))
        menu.addMenuItem(MenuItem("巨无霸", 15, False))
        menu.addMenuItem(MenuItem("薯条", 15, True))
